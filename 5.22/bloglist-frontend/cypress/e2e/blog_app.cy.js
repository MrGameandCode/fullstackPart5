...
describe('Blog app', function () {
    ...
    describe('When logged in', function () {
        ...
        it('A blog can be liked', function () {
            ...
            cy.get('#root > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(3) > div:nth-child(1) > button:nth-child(1)').click()
        ...
        it('Blogs are sorted by likes when loaded', function () {
            ...
            cy.get('#root > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > button:nth-child(1)').click()
            ...
            cy.get('.blogLikes').eq(0).invoke("text").then((text) => {
                const firstLikes = text.substring(0,text.indexOf('Like'))
                cy.log(firstLikes)
                cy.get('.blogLikes').eq(1).invoke("text").then((text2) => {
