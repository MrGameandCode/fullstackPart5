Please, as this code resuses the logging information from the previous part, you can just run the tests as "npm run silent_test" to get a clear response in terminal.
